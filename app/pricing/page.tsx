...
const features: FeatureRow[] = [
  ...
  {
    category: "Dashboard & Analytics",
    feature: "Filter by Rating, Sentiment, Date",
    starter: true,
    growth: true,
    scale: true,
  },
  {
    category: "Dashboard & Analytics",
    feature: "Sorting (newest, oldest, highest, lowest)",
    starter: true,
    growth: true,
    scale: true,
  },
  ...
  },
  {
    ...
    growth: true,
    scale: true,
    description: "Automatic summaries with GPT-4",
  },
  {
    category: "Dashboard & Analytics",
    feature: "AI Key Insights",
    starter: false,
    growth: true,
    scale: true,
  },
