...
const comparison = {
  title: 'Proofio vs Trustpilot',
  summary: 'Compare Proofio with Trustpilot for review management, AI analysis, and integrations.',
  proofio: {
    pros: [
...
export default function Page() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-gradient-to-br from-[#FAF8F5] to-[#F5F1EB] pt-24">
      <script
