...
export default function Page() {
  const benefits = [
    { title: 'Time Savings', description: 'Summarize reviews in seconds' },
    { title: 'Clear Themes', description: 'Identify key topics automatically' },
    { title: 'Actionable Insights', description: 'Get product improvement recommendations' },
    { title: 'Executive Reports', description: 'Share concise summaries with stakeholders' },
    { title: 'Multi-Language', description: 'Works across different languages' },
    { title: 'Update Tracking', description: 'Monitor feedback changes over time' },
  ];

  const useCases = [
    'Product managers understanding core customer pain points to prioritize roadmap',
    'Leadership teams making strategic decisions based on customer feedback summaries',
    'Sales teams using summaries in pitch decks to demonstrate product value',
    'Customer success teams identifying training or support gaps',
    'Marketing teams using insights in campaigns and positioning statements',
  ];
          ...
          <div className="container mx-auto px-4 max-w-5xl relative z-10">
            ...
            >
              ...
              <div className="relative bg-white rounded-[2.5rem] p-8 md:p-16 border border-base-200 shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">Distill Customer Feedback Into Actionable Insights</h2>
                  <p className="text-lg text-base-content/70 mb-4 leading-relaxed">
                    Reading through thousands of customer reviews is time-consuming and exhausting. Our AI-powered summaries automatically extract key themes, common complaints, and praised features into clear, concise reports you can act on immediately.
                  </p>
                  <p className="text-lg text-base-content/70 leading-relaxed">
                    Powered by advanced language models, Proofio generates coherent, accurate summaries that capture the essence of what customers are saying without losing important nuances.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <h2 className="text-3xl md:text-4xl font-black mb-4 tracking-tight">Get instant summaries of your reviews</h2>
                <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">Let AI do the heavy lifting on customer feedback analysis</p>
                <Link
                  href="/app/signup"
