...
const feature = {
  ...
  description: 'Stay on top of customer feedback with real-time monitoring across all sources',
};

export default function Page() {
  const benefits = [
    { title: 'Real-Time Sync', description: 'Receive new reviews instantly across platforms' },
    { title: 'Centralized Dashboard', description: 'Monitor all sources from one unified view' },
    { title: 'Multi-Platform Coverage', description: 'Track reviews from all integrated sources' },
    { title: 'Smart Filtering', description: 'Filter by platform, rating, date, or criteria' },
    { title: 'Automated Aggregation', description: 'Combine and deduplicate reviews automatically' },
    { title: 'Change Notifications', description: 'Get alerted on rating and sentiment changes' },
  ];

  const useCases = [
    'Customer success teams monitoring app store reviews for immediate support needs',
    'PR teams tracking brand mentions and public sentiment in real-time',
    'Product managers identifying regression patterns after updates or changes',
    'Quality assurance teams spotting bugs reported by users in public reviews',
    'Growth teams measuring the impact of marketing campaigns on user feedback',
  ];
          ...
          <div className="container mx-auto px-4 max-w-5xl relative z-10">
            ...
            >
              ...
              <div className="relative bg-white rounded-[2.5rem] p-8 md:p-16 border border-base-200 shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">Real-Time Review Intelligence</h2>
                  <p className="text-lg text-base-content/70 mb-4 leading-relaxed">
                    Review Monitoring keeps you constantly aware of what customers are saying about your product. With Proofio, new reviews are collected and analyzed automatically across all integrated platforms.
                  </p>
                  <p className="text-lg text-base-content/70 leading-relaxed">
                    Never miss critical feedback again. Whether it's a new 5-star review praising your latest feature or a 1-star complaint that needs immediate attention, Proofio ensures you're always informed.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <h2 className="text-3xl md:text-4xl font-black mb-4 tracking-tight">Never miss a customer review again</h2>
                <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">Get real-time monitoring across all your review sources</p>
                <Link
                  href="/app/signup"
