...
const feature = {
  name: 'Custom Reports',
  slug: 'custom-reports',
  description: 'Generate beautiful, comprehensive reports tailored to your stakeholders',
};

export default function Page() {
  const benefits = [
    { title: 'Flexible Templates', description: 'Create custom report layouts that match your brand' },
    { title: 'Scheduled Delivery', description: 'Automate reports to be sent on your schedule' },
    { title: 'Executive Summaries', description: 'Highlight key metrics and insights at a glance' },
    { title: 'Visual Dashboards', description: 'Transform data into compelling charts and graphs' },
    { title: 'White-Label Reports', description: 'Brand reports with your company logo and colors' },
    { title: 'Export Options', description: 'Download as PDF, Excel, or share via email' },
  ];

  const useCases = [
    'Executive teams reviewing monthly performance dashboards and strategic KPIs',
    'Account managers generating client reports with customized insights and recommendations',
    'Marketing teams analyzing campaign performance and ROI across multiple channels',
    'Finance teams creating compliance reports and budget tracking documents',
    'Stakeholders receiving automated weekly reports on business metrics and progress',
  ];
          ...
          <div className="container mx-auto px-4 max-w-5xl relative z-10">
            ...
            >
              ...
              <div className="relative bg-white rounded-[2.5rem] p-8 md:p-16 border border-base-200 shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight">What is Custom Reports?</h2>
                  <p className="text-lg text-base-content/70 mb-4 leading-relaxed">
                    Custom reports transform raw data into actionable insights presented in a format that speaks to your audience. With Proofio's reporting tools, you can create professional, branded reports without writing a single line of code.
                  </p>
                  <p className="text-lg text-base-content/70 leading-relaxed">
                    Schedule automated report generation and delivery, customize layouts for different stakeholder groups, and make data-driven decision-making accessible to everyone on your team.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 text-center">
                <h2 className="text-3xl md:text-4xl font-black mb-4 tracking-tight">Impress stakeholders with data</h2>
                <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">Create custom reports in minutes, not hours</p>
                <Link
                  href="/app/signup"
