      ...
      <defs>
        ...
        >
          <path
            ...
            stroke="currentColor"
            strokeWidth="1"
            className="text-base-content/10 dark:text-base-content/20" 
          />
        </motion.pattern>
      </defs>
...
export default function InfiniteGrid() {
  ...
  // Create a dynamic radial mask for the "flashlight" effect - using primary green
  const maskImage = useMotionTemplate`radial-gradient(300px circle at ${mouseX}px ${mouseY}px, hsl(160, 65%, 45%), transparent)`;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute left-[-10%] bottom-[-20%] w-[40%] h-[40%] rounded-full bg-primary/20 blur-[120px]" />
      </div>
    </div>
  );
}
